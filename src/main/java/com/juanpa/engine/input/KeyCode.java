...
// Enum for KeyCodes, mapping to GLFW constants
public enum KeyCode {
	// Printable keys
	...
	WORLD_1(GLFW.GLFW_KEY_WORLD_1), // Non-US #1
	WORLD_2(GLFW.GLFW_KEY_WORLD_2), // Non-US #2
	...
	public static KeyCode fromGlfwCode(int glfwCode) {
		for (KeyCode kc : values()) {
			if (kc.glfwKeyCode == glfwCode) {
				return kc;
			}
		}
		return UNKNOWN;
